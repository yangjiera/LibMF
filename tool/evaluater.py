...
def evaluate(U, V, UI_test):
    ...
    for i in UI_test:
        ...
        rating_predicted = sorted(
            rating_predicted, key=lambda rating_predicted: rating_predicted[1], reverse=True)
        performance_at_1 = append_precision_recall(
            performance_at_1, rating_predicted[0:1], UI_test[i])
        performance_at_5 = append_precision_recall(
            performance_at_5, rating_predicted[0:5], UI_test[i])
        performance_at_10 = append_precision_recall(
            performance_at_10, rating_predicted[0:10], UI_test[i])
